...
if __name__ == '__main__':
    ...
    MTGC = train_MTGC(data_obj=data_obj, learning_rate=learning_rate,
    ...
    torch.save(data_to_save, 'results/test_MTGC_noniid_{}_N{}_H{}_E{}.pt'.format(index, num_cells, epoch, E))
